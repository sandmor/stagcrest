...
pub fn register_all_biomes(reg: &mut impl ContentRegistrar) {
    ...
    reg.register_biome(RegisterBiomeRequest {
        ...
        dimension: BiomeDimension::Surface,
        temperature: NoiseRange::new(0.2, 1.5),
        humidity: NoiseRange::new(0.3, 0.9),
        continentalness: NoiseRange::new(-0.3, 0.3),
        erosion: NoiseRange::new(0.3, 0.9),
        depth: NoiseRange::new(0.0, 0.3),
        weirdness: NoiseRange::new(-0.5, 0.5),
        offset: 0.3,
        surface_top: "stagcrest:sand".into(),
    ...
    reg.register_biome(RegisterBiomeRequest {
        ...
        dimension: BiomeDimension::Surface,
        temperature: NoiseRange::new(-0.5, 0.15),
        humidity: NoiseRange::new(0.3, 0.8),
        continentalness: NoiseRange::new(-0.3, 0.3),
        erosion: NoiseRange::new(0.3, 0.9),
        depth: NoiseRange::new(0.0, 0.3),
        weirdness: NoiseRange::new(-0.5, 0.5),
    ...
    reg.register_biome(RegisterBiomeRequest {
        ...
        humidity: NoiseRange::new(0.3, 0.9),
        continentalness: NoiseRange::new(-0.3, 0.3),
        erosion: NoiseRange::new(0.2, 0.8),
        depth: NoiseRange::new(0.0, 0.3),
        weirdness: NoiseRange::new(-0.5, 0.5),
        offset: 0.2,
        surface_top: "stagcrest:sand".into(),
